...
export interface IBookingRepository {
    ...
    updateStatus(id: string, status: string, reason?: string, refundDetails?: { amount: number, status: 'full' | 'partial' }, lawyerFeedback?: string, session?: mongoose.ClientSession, penaltyAmount?: number): Promise<void>;
