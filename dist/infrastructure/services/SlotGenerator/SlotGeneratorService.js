...
class SlotGeneratorService {
    static generateSlots(rule) {
        ...
        while (startDate <= endDate) {
            ...
            if (rule.availableDays.includes(dayName) &&
                ...
                while (currentStart < dayEndTime) {
                    ...
                    currentStart = new Date(currentStart.getTime() + (slotDuration + bufferTime) * 60000);
                }
            }
...
//# sourceMappingURL=SlotGeneratorService.js.map