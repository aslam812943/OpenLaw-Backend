...
exports.VerificationLawyerDTO = void 0;
class VerificationLawyerDTO {
    constructor(data) {
        if (!data.userId) {
...
exports.VerificationLawyerDTO = VerificationLawyerDTO;
//# sourceMappingURL=VerificationLawyerDTO.js.map