...
exports.RejectLawyerUseCase = void 0;
class RejectLawyerUseCase {
    constructor(_lawyerRepo, _mailService) {
        this._lawyerRepo = _lawyerRepo;
        this._mailService = _mailService;
    }
    async execute(id, email, reason) {
        // Reject the lawyer in the repository
        await this._lawyerRepo.rejectLawyer(id);
        await this._mailService.sendMail(email, "⚠️ Regarding Your Lawyer Verification Status - LegalConnect Platform", `
...
exports.RejectLawyerUseCase = RejectLawyerUseCase;
//# sourceMappingURL=RejectLawyerUseCase.js.map